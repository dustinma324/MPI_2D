...
//    setAlltoValue(phi, nrow, ncol, nGhostLayers, ( REAL ) myRank + 1.0);
    ...
    if (myRank == 0) outputMatrix1(phi, nrow, ncol, nGhostLayers, "Process0.vtk");
    if (myRank == 1) outputMatrix1(phi, nrow, ncol, nGhostLayers, "Process1.vtk");
    if (myRank == 2) outputMatrix1(phi, nrow, ncol, nGhostLayers, "Process2.vtk");
    if (myRank == 3) outputMatrix1(phi, nrow, ncol, nGhostLayers, "Process3.vtk");
