...
void boundaryConditions(REAL *phi, const INT ncol, const INT nrow, const int nGhostLayers, const int *direction);
void decomposeMesh_2D(INT *coord_2D, INT *direction, INT *location, INT *p_location, INT *nrow, INT *ncol);
void exchange_ISend_and_IRecv(REAL *phi, const int *direction, const INT ncol, const INT nrow, const int nGhostLayers);
